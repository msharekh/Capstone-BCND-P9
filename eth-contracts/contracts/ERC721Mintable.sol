...
contract Pausable is Ownable{
    ...
    modifier whenNotPaused() {
        require(_paused == false, "status is paused");
        _;
    }
    modifier paused() {
        require(_paused == true, "status is not paused");
        _;
    }
    //  5) create a Paused & Unpaused event that emits the address that triggered the event
    // DONE
    event Paused(bool _status );
    event Unpaused(bool _status );
...
contract ERC721 is Pausable, ERC165 {
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        require(owner != address(0) , "not valid owner");
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "This is the owner of token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        // DONE z
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender),
            "sender is neither the owner of the contract nor value isApprovedForAll() is true"
        );
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        // DONE z
        require(!_exists(tokenId), "given tokenId already minted");
...
contract CustomERC721Token is ERC721Metadata("Sweet Token","MSH","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/")
{
