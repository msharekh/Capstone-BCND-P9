...
contract('TestSquareVerifier', accounts => {
    ...
    describe('Test verification', function () {
        ...
        it('(8) .... Test verification with incorrect proof', async function () {
            let a = incorrect_proofJSON.proof.A;
            let a_p = incorrect_proofJSON.proof.A_p;

            let b = incorrect_proofJSON.proof.B;
            let b_p = incorrect_proofJSON.proof.B_p;

            let c = incorrect_proofJSON.proof.C;
            let c_p = incorrect_proofJSON.proof.C_p;

            let h = incorrect_proofJSON.proof.H;
            let k = incorrect_proofJSON.proof.K;

            let input = incorrect_proofJSON.input;
